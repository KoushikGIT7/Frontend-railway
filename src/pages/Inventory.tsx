...
import { Package, Plus, Search, Filter, Edit, Trash2, AlertTriangle, CheckCircle, RefreshCw } from 'lucide-react';
...
const Inventory: React.FC = () => {
  ...
  // Enhanced mock products for manufacturer inventory
  const mockProducts: Product[] = [
    ...
    {
      id: 'CABLE-CB123',
      name: 'High Voltage Railway Cable',
      category: 'Electrical Equipment',
      manufacturer: 'Power Grid Solutions',
      batchNumber: 'BATCH2024-006',
      qrCode: 'QR-CB123-2024',
      blockchainHash: '0x567yza890bcd123abc456def789ghi012jkl345mno678pqr901stu234vwx',
      manufacturedDate: new Date('2024-01-20'),
      status: 'manufactured',
      location: 'Electrical Warehouse - Pune'
    },
    {
      id: 'SENSOR-SN456',
      name: 'Track Monitoring Sensor',
      category: 'Signaling Equipment',
      manufacturer: 'Smart Rail Technologies',
      batchNumber: 'BATCH2024-007',
      qrCode: 'QR-SN456-2024',
      blockchainHash: '0x890bcd123abc456def789ghi012jkl345mno678pqr901stu234vwx567yza',
      manufacturedDate: new Date('2024-01-18'),
      status: 'dispatched',
      location: 'In Transit to Bangalore Division'
    },
    {
      id: 'WELD-WD789',
      name: 'Rail Welding Equipment',
      category: 'Maintenance Tools',
      manufacturer: 'Industrial Welding Corp',
      batchNumber: 'BATCH2024-008',
      qrCode: 'QR-WD789-2024',
      blockchainHash: '0xbcd123abc456def789ghi012jkl345mno678pqr901stu234vwx567yza890',
      manufacturedDate: new Date('2024-01-22'),
      status: 'manufactured',
      location: 'Tool Warehouse - Chennai'
    },
    {
      id: 'BRIDGE-BG321',
      name: 'Steel Bridge Component',
      category: 'Infrastructure',
      manufacturer: 'Bridge Construction Ltd',
      batchNumber: 'BATCH2024-009',
      qrCode: 'QR-BG321-2024',
      blockchainHash: '0x123abc456def789ghi012jkl345mno678pqr901stu234vwx567yza890bcd',
      manufacturedDate: new Date('2024-01-25'),
      status: 'manufactured',
      location: 'Heavy Equipment Yard - Kolkata'
    },
    {
      id: 'COMM-CC654',
      name: 'Railway Communication System',
      category: 'Signaling Equipment',
      manufacturer: 'Telecom Solutions India',
      batchNumber: 'BATCH2024-010',
      qrCode: 'QR-CC654-2024',
      blockchainHash: '0x456def789ghi012jkl345mno678pqr901stu234vwx567yza890bcd123abc',
      manufacturedDate: new Date('2024-01-28'),
      status: 'dispatched',
      location: 'In Transit to Hyderabad Division'
    }
  ];
  ...
  const loadProducts = async () => {
    setLoading(true);
    try {
      // Start with mock products for UI structure
      let allProducts = [...mockProducts];
      
      // Try to load real products from Firestore (fast access) - non-blocking
      const firestorePromise = fetch('/api/getProductsFast')
        ...
        .then(data => {
          if (data.products && data.products.length > 0) {
            // Convert Firestore products to Product format
            const firestoreProducts: Product[] = data.products.map((product: any) => ({
              id: `LIVE-${product.id}`,
              name: product.name,
  ...
  const categories = ['Rail Components', 'Signaling Equipment', 'Fastening Systems', 'Track Components', 'Electrical Equipment', 'Maintenance Tools', 'Infrastructure'];
